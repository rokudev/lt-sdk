/*******************************************************************************
 * <unittest/lt/core/UnitTestLTCoreConsoleTests.h>
...
/* This space reserved for a ReadLine test. */

/* Test ConsolePrint().  Output obviously must be visually inspected. */

void TestConsolePrint(Tilt * tilt) {
    LT_UNUSED(tilt);
    LT_GetCore()->ConsolePrint(
            "The Network Is The Computer, This Time For Real (TM).\n");
}
