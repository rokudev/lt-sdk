 ...
 *                          : -1 - Error
 */
int WebRtcAgc_set_config(void* agcInst, LTMediaMicrophoneAGC_Config config);
...
/*
 * This function sets microphone volume
 *
 * Input:
 *      - agcInst           : AGC instance.
 *      - minLevel          : Microphone volume
 */

void WebRtcAgc_SetMicVol(void* agcInst, int32_t micVol);
