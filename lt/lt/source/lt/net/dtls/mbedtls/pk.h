...
uint16_t LTNetDtls_SignCertVerify(void *clientPrivateKeyReference, const uint8_t hash[32], uint8_t *x962Signature, uint16_t sigMaxSize);
bool LTNetDtls_VerifySigHash(mbedtls_pk_context *ctx, const uint8_t hash[32], const uint8_t *x962Signature, uint16_t x962SigLen);
