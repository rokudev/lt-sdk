...
LT_DNS_TABLE_SIZE := $(shell $(LT_TARGET_DIR_BUILDTOOLS)/bin/peekjson "config/product/lwip/LT_DNS_TABLE_SIZE" $(LT_PRODUCT_CONFIG_ARBOLATED_JSON_FILE))
...
ifneq ($(strip $(LT_DNS_TABLE_SIZE)),)
LT_CFLAGS_GENERIC += -DLT_DNS_TABLE_SIZE=$(LT_DNS_TABLE_SIZE)
endif
