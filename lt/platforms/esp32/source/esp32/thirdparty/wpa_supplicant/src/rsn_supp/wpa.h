...
/*
 * Roku: was #ifdef.  The vendored sdkconfig.h spells out the targets it is not
 * as 0 rather than leaving them undefined, so #ifdef picks the esp32 header on
 * every part.  The two siblings below already test the value.
 */
#if CONFIG_IDF_TARGET_ESP32
#include "esp32/rom/ets_sys.h" // will be removed in idf v5.0
#elif CONFIG_IDF_TARGET_ESP32S2
#include "esp32s2/rom/ets_sys.h"
/* Roku: added - see the note in src/utils/includes.h. */
