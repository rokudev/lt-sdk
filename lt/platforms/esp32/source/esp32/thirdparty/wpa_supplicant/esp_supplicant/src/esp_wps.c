...
/*
 * Roku: added.  IDF pulls these in through esp_private/wifi.h, whose vendored
 * copy drops freertos/queue.h because LT is not FreeRTOS.  See
 * roku-lt-port/freertos/FreeRTOS.h for what stands in for it.
 */
