...
// md5_digest_table 79282a4670142ce426099b9efb61cd25
...
static const esp_efuse_desc_t SECURE_VERSION[] = {
    {EFUSE_BLK3, 128, 16}, 	 // Secure version for anti-rollback,
};

static const esp_efuse_desc_t BOOT_SECURE_VERSION[] = {
    {EFUSE_BLK3, 144, 16}, 	 // ,
};
...
const esp_efuse_desc_t* ESP_EFUSE_BOOT_SECURE_VERSION[] = {
    &BOOT_SECURE_VERSION[0],    		// 
    NULL
};
