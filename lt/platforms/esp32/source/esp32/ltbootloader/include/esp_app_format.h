...
typedef struct {
    ...
    uint8_t major_rev;          /*!< Major firmware revision number */
    uint8_t minor_rev;          /*!< Minor firmware revision number */
    uint8_t reserved[6];       /*!< Reserved bytes in additional header space, currently unused */
