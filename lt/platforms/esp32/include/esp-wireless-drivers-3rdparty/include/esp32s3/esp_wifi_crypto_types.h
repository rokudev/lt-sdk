 ...
 */
/*
 * Roku: ESP-IDF v4.4.8's components/esp_wifi/include/esp_wifi_crypto_types.h,
 * verbatim.  Split per chip for the same reason as esp_wifi_types.h beside it -
 * see the selector one directory up.  What differs here is esp_aes_gmac_t and the
 * aes_gmac entry it adds to the tail of wpa_crypto_funcs_t, which is the table
 * src/crypto/crypto_ops.c hands the blobs.
 */
