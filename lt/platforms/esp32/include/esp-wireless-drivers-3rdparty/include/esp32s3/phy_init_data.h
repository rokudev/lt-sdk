 ...
 *
 * Vendored from ESP-IDF v4.4 components/esp_phy/esp32s3/include/phy_init_data.h.
 * The only edits are the two Kconfig option names, renamed to the pre-v4.4 spelling
 * that the sdkconfig.h alongside this file still uses.
 */
