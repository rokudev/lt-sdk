 ...
 *
 * Derived from the esp32c3 configuration in this tree, which is the closest
 * match Espressif ships: in ESP-IDF v4.4 the esp32s3 uses the esp32c3 wireless
 * and bluetooth component sources.  Only the target identity, the toolchain
 * prefix and the CONFIG_ESP32C3_* option names are changed.
 */
#pragma once
...
#define CONFIG_ESP32S3_REV_MIN_3 1
#define CONFIG_ESP32S3_REV_MIN 3
...
#define CONFIG_ESP32S3_TIME_SYSCALL_USE_RTC_SYSTIMER 1
#define CONFIG_ESP32S3_RTC_CLK_SRC_INT_RC 1
#define CONFIG_ESP32S3_RTC_CLK_CAL_CYCLES 1024
#define CONFIG_ESP32S3_LIGHTSLEEP_GPIO_RESET_WORKAROUND 1
...
#define CONFIG_ESP32S3_MEMPROT_FEATURE CONFIG_ESP_SYSTEM_MEMPROT_FEATURE
#define CONFIG_ESP32S3_MEMPROT_FEATURE_LOCK CONFIG_ESP_SYSTEM_MEMPROT_FEATURE_LOCK
