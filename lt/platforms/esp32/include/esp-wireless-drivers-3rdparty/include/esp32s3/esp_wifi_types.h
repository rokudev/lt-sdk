 ...
 */
/*
 * Roku: ESP-IDF v4.4.8's components/esp_wifi/include/esp_wifi_types.h, verbatim.
 * Reached through the chip selector one directory up, which says why the copies
 * are split.  This is the revision the esp32s3 blobs under
 * source/esp32/mastering/lib/esp32s3 were cut from; esp32/esp_wifi_types.h is the
 * older one that matches the esp32 blobs.
 */
