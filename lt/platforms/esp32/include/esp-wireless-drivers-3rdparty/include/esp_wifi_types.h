...
typedef struct {
    bool capable;            /**< Advertises support for Protected Management Frame. Device will prefer to connect in PMF mode if other device also advertises PMF capability. */
