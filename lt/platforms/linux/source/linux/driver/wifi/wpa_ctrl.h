...
/**
 * wpa_ctrl_and_p2p_ipc_socket_pending - similar to wpa_ctrl_pending() except
 * this function also monitors the second socket passed in as p2p_ipc_sock
 * @ctrl: Control interface data from wpa_ctrl_open()
 * @p2p_ipc_sock second second to monitor
 * Returns: a bitmap, bit is set if the socket has data
