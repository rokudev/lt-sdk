...
LT_PROJECT_SOURCE_FILES      += LTDriverCryptoHmacSha1.c
LT_PROJECT_SOURCE_FILES      += LTDriverCryptoHmacSha256.c
LT_PROJECT_SOURCE_FILES      += LTDriverCryptoSeqHmacSha256.c

LT_PROJECT_SOURCE_FILES      += LTDriverCryptoDrbg.c
LT_PROJECT_SOURCE_FILES      += LTDriverCryptoRandom.c

LT_PROJECT_SOURCE_FILES      += LTDriverCryptoAes128.c
LT_PROJECT_SOURCE_FILES      += LTDriverCryptoAes128Cbc.c
LT_PROJECT_SOURCE_FILES      += LTDriverCryptoAes128Ctr.c
LT_PROJECT_SOURCE_FILES      += LTDriverCryptoAes128Gcm.c
LT_PROJECT_SOURCE_FILES      += LTDriverCryptoAes128Xts.c

LT_PROJECT_SOURCE_FILES      += LTDriverCrypto25519.c
LT_PROJECT_SOURCE_FILES      += LTDriverCryptoX25519.c
...
LT_PROJECT_SOURCE_FILES      += LTDriverCryptoSecureSha256.c
