...
DEFINE_LTLOG_SECTION("common.drv.wifi");
...
define_LTDEVICE_DRIVER_IMPLEMENTATION(LTDriverWiFi, CommonDriverWiFi);
/*
...
static bool CommonDriverWiFiImpl_LibInit(void) {
    pCore = LT_GetCore();
...
static void CommonDriverWiFiImpl_LibFini(void) {
...
static u32 CommonDriverWiFiImpl_GetNumDeviceUnits(void) {
...
static LTDeviceUnit CommonDriverWiFiImpl_CreateDeviceUnitHandle(u32 nDeviceUnitNumber) {
...
static void CommonDriverWiFi_OnDestroyHandle(LTHandle h_unit) {
    GET_UNIT(unit, h_unit);
...
define_LTLIBRARY_INTERFACE(LTDriverWiFi, CommonDriverWiFi_OnDestroyHandle) {
