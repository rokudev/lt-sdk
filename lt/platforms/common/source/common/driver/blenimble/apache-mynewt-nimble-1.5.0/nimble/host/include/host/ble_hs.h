...
/**
 * Get reason for resetting BLE Controller, mostly for logging and tracking.
 * 
 * @return Reason for reset, which is one of the HAL_RESET_[...] codes.
 */
int ble_hs_controller_get_reset_reason(void);
